...
public class EventManagement extends HttpServlet{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 588855919090065588L;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		response.getWriter().print(eventSingleThresholdService.getBySearchSupplier(searchCondition));
		System.out.println((eventSingleThresholdService.getBySearchSupplier(searchCondition)));
	}
}
