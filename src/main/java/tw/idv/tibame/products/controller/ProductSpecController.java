...
public class ProductSpecController {
	...
	public List<ProductSpecManageDTO> getAllProductSpecManage(@RequestBody Map<String, String> requestData) throws Exception {
	...
	public List<ProductSpecManageDTO> getSoldProductSpecManage(@RequestBody Map<String, String> requestData) throws Exception {
		String registerSupplier = requestData.get("registerSupplier");
	...
	public List<ProductSpecManageDTO> getUpStatusProductSpecManage(@RequestBody Map<String, String> requestData) throws Exception {
		String registerSupplier = requestData.get("registerSupplier");
	...
	public List<ProductSpecManageDTO> getDownStatusProductSpecManage(@RequestBody Map<String, String> requestData) throws Exception {
		String registerSupplier = requestData.get("registerSupplier");
	...
	public List<ProductSpecManageDTO> getDownStatusSearch(@RequestBody Map<String, String> requestData) throws Exception {
		String optionName = requestData.get("optionName");
		String searchText = requestData.get("searchText");
		String registerSupplier = requestData.get("registerSupplier");
